...
namespace Hypnocube.PICFlasher
{
    ...
    public sealed class ChaCha
    {
        ...
        static byte[] sigma = ASCIIEncoding.ASCII.GetBytes("expand 32-byte k");
        static byte[] tau   = ASCIIEncoding.ASCII.GetBytes("expand 16-byte k");
